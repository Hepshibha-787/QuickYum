    ...
    <div className='container'>
        <form className='form' onSubmit={onHandleSubmit}>
            ...
            <div className='form-control'>
                ...
                <textarea type="text" className='input-text-area' name="ingredients" rows="5" onChange={onHandleChange} value={recipeData.ingredients}></textarea>
            </div>
            <div className='form-control'>
                <label>Instructions</label>
                <textarea type="text" className='input-text-area' name="instructions" rows="5" onChange={onHandleChange} value={recipeData.instructions}></textarea>
            </div>
            <div className='form-control'>
